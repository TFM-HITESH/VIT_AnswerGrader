        ...
        <div className="flex-col flex-1 xl:flex">
          ...
          <div className="px-4 py-6 sm:px-6 lg:pl-8 xl:flex-1 xl:pl-6">
            ...
            <div className="flex flex-row h-[20vh] w-full m-3 rounded-lg bg-blue-600/25 justify-left items-center p-2">
                ...
                <Input
                  type="text"
                  placeholder="Enter the model answer key here !"
                  className=" w-4/5 h-5/6 m-3 rounded-lg bg-zinc-100 text-gray-800/50 p-3 text-wrap"
                />
              ...
              <Button type="submit" className="h-5/6">Submit</Button>
            </div>
          </div>
        </div>
